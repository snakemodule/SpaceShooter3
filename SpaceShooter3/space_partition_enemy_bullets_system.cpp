...
void systems::space_partition_enemy_bullets::register_archetype(Archetype& matching_archetype)
{
...
void systems::space_partition_enemy_bullets::partition()
{
	indexing::space_partition::enemy_bullet_position_map.clear();
	...
	for (size_t i = 0; i < archetype_count; i++)
	{
		...
		{
			indexing::space_partition::enemy_bullet_position_map.insert(
